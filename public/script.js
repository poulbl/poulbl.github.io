...
const btnThemeBlue = document.getElementById('theme-blue')
...
*/
//btnThemeBlue.addEventListener('themeblue', ChangeTheme)
InitTheme();
...
function InitTheme() {
    ...
    if (storedTheme) {
        htmlEl.dataset.theme = storedTheme
    }
}
...
const populateData = (data, searchType, caller) => {
    ...
    if(caller === 'forecast')
    {
        ...
        data.forEach(element => {
            ...
            headline.setAttribute('class', 'text')
...
async function ChangeTheme(theme)
{
    ...
    console.log('theme should be ' + targetTheme)
}



/*
var checkbox = documnet.querySelector('input[name=theme]')
